...
<head>
    ...
    <title>Freshbite | Out of stock Products</title>
            ...
            <div class="posBox-container"  id="posContainer">
                <div class="posBox">
                    ...
                    <div class="tab-div">
                        ...
                        <a href="outstock.php"><button class="btnactive">Out of stock products</button></a>
                    </div>
                    </div>
                ...
                <table class="tableSales">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql_get="SELECT * FROM `products` WHERE  quantity < 10";
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="editproduct.php" method="POST">
                                    ...
                                    <button class="btn btnEdit" name="btnEdit">Update</button>
                                </form>
                            </td>
