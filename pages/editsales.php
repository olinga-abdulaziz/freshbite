...
<head>
    ...
    <title>Freshbite | Edit Sales</title>
...
<body>
            ...
            <div class="posBox-container"  id="posContainer">
                <div class="posBox">
                    ...
                    if (isset($_POST['btnEdit'])) {
                        ...
                        $date=$_POST['date'];
                    ?>
                    <form class="pos-form" action="editsales.php" method="POST">
                        <div class="sale-form">
                            <div class="input-div">
                            ...
                            <div class="input-div">
                               <label for=""   class="input-label">Date</label> <br>
                                <input type="text" value="<?php echo $date ?>" name="date" placeholder="Enter price" class="input">
                            </div>
                            <div class="input-div">
    ...
    if (isset($_POST['btnUpdate'])) {
        ...
        $sql_insert="UPDATE `sales` SET `product`='$product',`size`='$size',`quantity`='$quantity',`price`='$price',`date`='$date' WHERE id='$id'";
            ...
            <div class="pop-container">
                <div class="pop-up">
                    <center>
                        ...
                        <br>
                        <div>
                            <small>Sales Updated successfully !</small>
                        </div>
